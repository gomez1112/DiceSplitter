...
final class Game {
    ...
    var isGameOver: Bool {
        ...
        // Condition 4: Any player cannot make a valid move
        let anyPlayerCannotMove = players.contains { player in
            !hasValidMoves(for: player)
        }
        
        return allOwnedByOnePlayer || noValidMovesForAnyPlayer || aiCannotMove || anyPlayerCannotMove
    }
